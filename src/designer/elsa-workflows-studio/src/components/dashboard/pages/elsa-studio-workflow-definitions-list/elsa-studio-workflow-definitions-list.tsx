...
export class ElsaStudioWorkflowDefinitionsList {
  ...
  render() {
    ...
    return (
      <div>
        <div class="elsa-border-b elsa-border-gray-600 elsa-px-4 elsa-py-4 sm:elsa-flex sm:elsa-items-center sm:elsa-justify-between sm:elsa-px-6 lg:elsa-px-8 elsa-bg-gray-700">
