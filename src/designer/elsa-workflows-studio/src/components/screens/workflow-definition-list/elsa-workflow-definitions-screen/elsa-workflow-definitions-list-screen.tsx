              ...
              <form class="elsa-w-full elsa-flex md:ml-0" onSubmit={e => this.onSearch(e)}>
                ...
                <div class="elsa-relative elsa-w-full elsa-text-gray-300 focus-within:elsa-text-gray-300">
                  ...
                  <input name="searchTerm"
                         class="elsa-text-gray-300 elsa-block elsa-bg-gray-700 elsa-w-full elsa-h-full elsa-pl-8 elsa-pr-3 elsa-py-2 elsa-rounded-md elsa-placeholder-gray-500 focus:elsa-placeholder-gray-400 sm:elsa-text-sm elsa-border-0 focus:elsa-outline-none focus:elsa-ring-0"
