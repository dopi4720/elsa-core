...
export class ElsaFunctionDefinitionsListScreen {
   ...
   //TODO:FIX THIS     //await elsaClient.functionDefinitionsApi.delete(functionDefinition.functionId, { allVersions: true });
        await this.loadFunctionDefinitions();
    }

    async routeChanged(e: LocationSegments) {

        if (!e.pathname.toLowerCase().endsWith('function-definitions'))
            return;
